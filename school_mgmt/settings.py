...
SECRET_KEY = "django-insecure-usmiv%ajg)tfblmu0tr7&rh85zn#j10-p25%)ted+amdacm#*9"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ["195.35.6.12", "vediqedu.in", "www.vediqedu.in"]
...
# Static files (CSS, JavaScript, Images)
STATIC_URL = "/static/"
STATIC_ROOT = os.path.join(BASE_DIR, "staticfiles")  # or another path of your choice
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "vediq.educations@gmail.com"
EMAIL_HOST_PASSWORD = "wraffvmzjjubxvks"
